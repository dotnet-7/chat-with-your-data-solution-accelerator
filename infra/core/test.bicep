...
param WebsiteName string = '${ResourceToken}-website'

@description('Name of Application Insights')
param ApplicationInsightsName string = '${ResourceToken}-appinsights'
...
param AzureSearchIndex string = '${ResourceToken}-index'

@description('Azure Cognitive Search Conversation Log Index')
param AzureSearchConversationLogIndex string = 'conversations'

@description('Name of Storage Account')
param StorageAccountName string = '${ResourceToken}str'

@description('Name of Function App for Batch document processing')
param FunctionName string = '${ResourceToken}-backend'
...
param HostingPlanName string = '${ResourceToken}-hosting-plan'
